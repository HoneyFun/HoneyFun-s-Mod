package com.lyghtningwither.honeyfunmods.world;
...
public class ExplosionNoShooterDamage extends Explosion {
	...
	public ExplosionNoShooterDamage(World worldIn, Entity entityIn, double x, double y, double z, float size, boolean flaming, boolean damagesTerrain) {
