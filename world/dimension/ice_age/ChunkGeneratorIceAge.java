...
import com.lyghtningwither.honeyfunmods.world.gen.WorldGenStructure;
...
public class ChunkGeneratorIceAge implements IChunkGenerator
{
    protected static final IBlockState AIR = Blocks.AIR.getDefaultState();
    protected static final IBlockState BEDROCK = ModBlocks.ICY_BEDROCK.getDefaultState();
    
    //Block that is usually Netherrack
    protected static final IBlockState MAIN_BLOCK = Blocks.PACKED_ICE.getDefaultState();
    ...
    protected static final IBlockState OTHER_BLOCK1 = Blocks.ICE.getDefaultState();
    protected static final IBlockState OTHER_BLOCK2 = ModBlocks.ICY_OPAL_ORE.getDefaultState();
    ...
    */
    ...
    public ChunkGeneratorIceAge(World world, boolean generate, long seed)
    {
        this.world = world;
    ...
    public Chunk generateChunk(int x, int z)
    {
        ...
        {
            abyte[i] = (byte)Biome.getIdForBiome(BiomeInit.ICE_AGE);
        }
