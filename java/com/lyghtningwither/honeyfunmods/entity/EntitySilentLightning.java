...
public class EntitySilentLightning extends EntityWeatherEffect
{
    ...
    public EntitySilentLightning(World worldIn, double x, double y, double z, boolean effectOnlyIn)
    {
        super(worldIn);
    ...
    public void onUpdate()
    {
        ...
        {
            this.world.playSound((EntityPlayer)null, this.posX, this.posY, this.posZ, SoundEvents.ENTITY_LIGHTNING_IMPACT, SoundCategory.WEATHER, 5.0F, 0.5F + this.rand.nextFloat() * 0.2F);
        }
        ...
        if (this.lightningState >= 0)
        {
            ...
            else if (!this.effectOnly)
            {
                ...
                for (int i = 0; i < list.size(); ++i)
                {
                    ...
                    if (!net.minecraftforge.event.ForgeEventFactory.onEntityStruckByLightning(entity, (EntityLightningBolt)((EntityWeatherEffect)this)))
                        entity.onStruckByLightning((EntityLightningBolt)((EntityWeatherEffect)this));
                }
            }
        }
    }
