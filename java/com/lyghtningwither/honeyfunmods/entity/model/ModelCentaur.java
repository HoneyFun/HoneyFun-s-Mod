package com.lyghtningwither.honeyfunmods.entity.model;
...
public class ModelCentaur extends ModelBase {
    ...
    public ModelCentaur() {
        ...
        this.VillagerMiddleArm.setRotationPoint(0.0F, -15.0F, -5.0F);
        ...
        this.VillagerLeftArm.setRotationPoint(0.5F, -5.0F, -10.0F);
        this.VillagerLeftArm.addBox(4.0F, -15.0F, -2.0F, 4, 8, 4, 0.0F);
        ...
        this.VillagerRightArm.setRotationPoint(0.5F, -5.0F, -10.0F);
        this.VillagerRightArm.addBox(-8.0F, -15.0F, -2.0F, 4, 8, 4, 0.0F);
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn) {
    	...
    	this.FrontLeftLeg.rotateAngleX = MathHelper.cos(limbSwing * .6662f) * 1.4f * limbSwingAmount;
    	this.Rearleftleg.rotateAngleX = MathHelper.cos(limbSwing * .6662f) * 1.4f * limbSwingAmount;
    	
    	this.FrontRightLeg.rotateAngleX = MathHelper.cos(limbSwing * .6662f + (float) Math.PI) * 1.4f * limbSwingAmount;
    	this.Rearleftleg.rotateAngleX = MathHelper.cos(limbSwing * .6662f + (float) Math.PI) * 1.4f * limbSwingAmount;
    }
}
