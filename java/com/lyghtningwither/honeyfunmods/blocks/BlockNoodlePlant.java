...
public class BlockNoodlePlant extends BlockCrops {
	...
	public BlockNoodlePlant(String name) {
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn,
		...
		if(this.isMaxAge(state)) {
			...
			worldIn.spawnEntity(new EntityItem(worldIn, pos.getX(), pos.getY(), pos.getZ(), new ItemStack(ModItems.NOODLES, 2)));
