...
import com.lyghtningwither.honeyfunmods.blocks.item.ItemBlockVariants;
...
public class BlockOres extends Block implements IHasModel, IHasMetaName {
	...
	public BlockOres(String name, String dimension) {
		...
		setDefaultState(this.blockState.getBaseState().withProperty(VARIANT, EnumHandler.EnumType.OPAL_ORE));
	...
	@Override
	public String getSpecailName(ItemStack stack) {
